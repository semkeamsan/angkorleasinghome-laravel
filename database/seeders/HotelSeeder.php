...
class HotelSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $IDs[] = DB::table('bc_hotels')->insertGetId(
            [
                ...
                'badge_tags' => '[{"title":"Free breakfast","color":"green"},{"title":"Service VIP","color":"danger"}]',
            ]);
        $IDs_vendor[] = $create_user =  "1";
        $IDs[] = DB::table('bc_hotels')->insertGetId(
            [
        ...
        foreach ($IDs as $numer_key => $hotel_id){
            $vendor_id = $IDs_vendor[$numer_key];
            $IDs_room[] = DB::table('bc_hotel_rooms')->insertGetId(
                [
