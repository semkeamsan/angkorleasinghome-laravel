<div class="item">
    <div class="col dropdown-custom px-0 mb-4 form-select-guests">
        <span class="d-none text-gray-1 text-left font-weight-normal">{{ $field['title'] ?? "" }}</span>
        <div class="flex-horizontal-center px-2 bg-gray border-bottom border-width-2 border-color-1 d-flex  dropdown-toggle" data-toggle="dropdown" style="padding: 12px 0">
